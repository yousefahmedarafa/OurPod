#
#  Be sure to run `pod spec lint OurPod.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "YousefArafa"
  # spec.authors            = { "YousefArafa" => "yousefahmedarafa@outlook.com" }
  # spec.social_media_url   = "https://twitter.com/YousefArafa"
